...
namespace NewsContentManagement.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,commentContent,Date,NewsId")] Comment comment)
        {
            ...
            ViewBag.NewsId = new SelectList(db.News, "Id", "Title", comment.NewsId);
            return View(comment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,commentContent,Date,NewsId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
